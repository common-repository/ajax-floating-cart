...
Ajax Floating Cart offer:
	...
	4. Product sub total with quantity
...
* PHP version 7.3 or greater
* MySQL version 5.6 or greater
* WordPress Memory limit of 10 MB or greater
...
You can download form wordpress.org plugin archive or from my github ripository

**Is it free to use?**

Yes, it's totally free plugin

**How to use it?**

Just install from wordpress plugin archive and use it.


== Changelog ==

= 1.0.0 (08 Aug, 2021) =
* Product add, remove without page load.

== Upgrade Notice ==
* Product sub total and quantity added
* Product link added

= 1.0.1 =
* Tested latest WordPress version with php 7.4.9